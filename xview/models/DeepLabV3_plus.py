...
import numpy as np
from xview.models.resnet_v2 import resnet_v2_50
from xview.models.resnet_utils import resnet_arg_scope
import os, sys
...
def build_deeplabv3_plus(inputs, num_classes, preset_model='DeepLabV3_plus-Res50', weight_decay=1e-5, is_training=True, pretrained_dir="models"):
    """
    ...
    if preset_model == 'DeepLabV3_plus-Res50':
        with slim.arg_scope(resnet_arg_scope(weight_decay=weight_decay)):
            logits, end_points = resnet_v2_50(inputs, is_training=is_training, scope='resnet_v2_50')
